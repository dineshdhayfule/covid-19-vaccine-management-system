...
public class HomePage extends JFrame {
	...
	public HomePage() {
		...
		btnNewButton.setBounds(34, 395, 112, 46);
		...
		btnSingnup.setForeground(new Color(0, 0, 0));
		btnSingnup.setBorderPainted(false);
		btnSingnup.setBackground(new Color(255, 255, 255));
		btnSingnup.setFont(new Font("Tempus Sans ITC", Font.BOLD, 18));
		btnSingnup.setBounds(195, 395, 159, 46);
		...
		btnExit.setFont(new Font("Tempus Sans ITC", Font.BOLD, 18));
		btnExit.setBorderPainted(false);
		btnExit.setBorder(new LineBorder(new Color(0, 0, 0), 3, true));
		btnExit.setBackground(Color.WHITE);
		btnExit.setBounds(404, 395, 112, 46);
